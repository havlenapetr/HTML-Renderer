...
namespace HtmlRenderer
{
...
#endif
    {
        ...
        public static SizeF Measure(Graphics g, string html, float maxWidth, CssData cssData)
        {
        ...
        /// <returns>the size required for the html</returns>
        public static SizeF Measure(Graphics g, string html, float maxWidth, CssData cssData, EventHandler stylesheetLoad, EventHandler imageLoad)
        {
            ArgChecker.AssertArgNotNull(g, "g");
        ...
        public static SizeF Render(Graphics g, string html, float left, float top, float maxWidth, CssData cssData)
        {
        ...
        /// <param name="cssData">optiona: the style to use for html rendering (default - use W3 default style)</param>
        /// <returns>the actual size of the rendered html</returns>
        public static SizeF Render(Graphics g, string html, PointF location, SizeF maxSize, CssData cssData)
        {
            ArgChecker.AssertArgNotNull(g, "g");
        ...
        /// <param name="imageLoad">optional: can be used to overwrite image resolution logic</param>
        /// <returns>the actual size of the rendered html</returns>
        public static SizeF Render(Graphics g, string html, PointF location, SizeF maxSize, CssData cssData, EventHandler stylesheetLoad, EventHandler imageLoad)
        {
            ArgChecker.AssertArgNotNull(g, "g");
            ...
            if (!string.IsNullOrEmpty(html))
            {
                ...
                {
                    prevClip = g.Clip;
                    g.SetClip(new RectangleF(location.X, location.Y, maxSize.Width, maxSize.Height));
                }
#endif
